  ...
  const tabs = [
    {
      ...
      content: {
        ...
        description: "Nous croyons que chaque entrepreneur africain mérite d'avoir accès aux meilleures technologies. Notre mission est de démocratiser le digital en créant des solutions accessibles, performantes et adaptées au contexte local.",
        metrics: [
    ...
    },
    {
      ...
      content: {
        ...
        description: "De l'idée au déploiement, nous maîtrisons toute la chaîne de développement. Technologies modernes, bonnes pratiques, sécurité renforcée : nous livrons des solutions qui tiennent la route.",
        metrics: [
  ...
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <motion.div
          {...getScrollAnimationProps({ scale: 0.9, opacity: 0 }, { scale: 1, opacity: 1 })}
        ...
        >
          <div className="inline-flex items-center gap-2 mb-8">
            ...
            <span className="text-sm font-medium text-text-light">
              Équipe franco-camerounaise
            </span>
          </div>
          
          <h2 className="heading-1 mb-6">
            L'équipe qui <span className="text-gradient-warm">révolutionne</span>
            <br />
            le web en Afrique
          </h2>
          
          <p className="body-large max-w-2xl mx-auto">
            Trois développeurs, deux continents, une vision commune : 
            faire du digital un levier de croissance accessible à tous.
          </p>
        </motion.div>
        ...
        <div className="grid xl:grid-cols-3 gap-16 mb-32">
          ...
          <motion.div
            {...getScrollAnimationProps({ x: -60, opacity: 0 }, { x: 0, opacity: 1 })}
            className="space-y-6"
          >
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-text-strong">{member.name}</h4>
                ...
                >
                  <div className="flex flex-wrap gap-2 pt-4 border-t border-border">
                    {member.skills.map((skill, skillIndex) => (
                      <span key={skillIndex} className={`chip bg-${member.color}/10 text-${member.color}`}>
                        {skill}
                      </span>
                    ))}
                  </div>
        ...
        <motion.div
          {...getScrollAnimationProps({ y: 60, opacity: 0 }, { y: 0, opacity: 1 })}
          className="space-y-16"
        >
          <div className="text-center">
            <h3 className="heading-2 mb-6">Ce qui nous anime</h3>
            <p className="body-large max-w-3xl mx-auto">
              Des valeurs fortes qui guident chaque décision technique et chaque interaction client.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Fiers de nos origines, nous développons avec le cœur et l'authenticité de nos racines.",
                color: "secondary"
              },
              {
                icon: FiZap,
                title: "Excellence technique", 
                description: "Code propre, architecture solide, performances optimales. Pas de compromis sur la qualité.",
                color: "primary"
              },
              {
                icon: FiShield,
                title: "Transparence totale",
                description: "Communication claire, processus ouvert, pas de surprises. Vous savez toujours où vous en êtes.",
                color: "accent"
              },
              {
                icon: FiTrendingUp,
                title: "Impact durable",
                description: "Chaque projet vise à créer de la valeur long terme et contribuer à l'écosystème digital africain.",
                color: "success"
              }
            ].map((value, index) => (
              <motion.div
        ...
        >
          <div className="card-glass p-12 max-w-4xl mx-auto">
            ...
            <h3 className="heading-2 mb-6">
              Rejoignez les entrepreneurs qui nous font <span className="text-gradient-sunset">confiance</span>
            </h3>
            
            <p className="body-large mb-8 max-w-2xl mx-auto">
              De l'idée à la mise en ligne, nous transformons votre vision en solution digitale performante. 
