...
function AtoutsSection() {
  ...
  const atoutsData = [
    {
      ...
      description: "Sites ultra-optimisés pour smartphones avec UX parfaite sur tous les écrans",
    ...
    },
    {
      ...
      description: "Mobile Money, PayPal, Stripe - tout l'écosystème de paiement local et international",
    ...
    },
    {
      ...
      description: "Sites ultra-rapides, sécurité renforcée et référencement SEO optimisé",
    ...
    },
    {
      ...
      description: "React, Next.js, Node.js, Docker - les technologies les plus récentes pour votre succès",
    ...
    },
    {
      ...
      description: "Expérience Cameroun + formation France = solutions adaptées aux deux marchés",
    ...
    },
    {
      ...
      description: "Du besoin initial à la mise en ligne + formation et support continu après livraison",
  ...
  const statsData = [
    { icon: FiClock, value: "5+", label: "Années d'expérience", gradient: "from-blue-500 to-cyan-500" },
    { icon: FiUsers, value: "50+", label: "Clients satisfaits", gradient: "from-green-500 to-emerald-500" },
    { icon: FiAward, value: "100%", label: "Projets réussis", gradient: "from-purple-500 to-indigo-500" },
    { icon: FiShield, value: "24/7", label: "Support disponible", gradient: "from-orange-500 to-red-500" }
  ]
        ...
        <div className='container mx-auto px-4'>
          ...
          <motion.div
            ...
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/10 to-pink-500/10 px-4 py-2 rounded-full border border-purple-200/50 dark:border-purple-500/30 mb-6">
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Pourquoi me choisir</span>
            </div>
            ...
            <p className='text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed'>
              Des <strong>compétences techniques</strong> et une approche humaine qui font toute la différence.
              <br />
                ...
                <motion.div
                  ...
                  <div className='relative z-10 space-y-6'>
                    ...
                    <div className='flex items-center justify-between mb-4'>
                      <div className={`p-4 rounded-2xl bg-gradient-to-r ${atout.gradient} shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}>
                ...
                {statsData.map((stat, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${stat.gradient} rounded-2xl mb-4 group-hover:scale-110 transition-all duration-300 shadow-lg`}>
          ...
          <motion.div
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                Discutons de votre projet ! Consultation gratuite de 30 min pour définir la stratégie parfaite.
              </p>
