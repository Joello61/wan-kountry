  ...
  const realisationsList = [
    {
      ...
      description:
        'Site élégant et moderne pour une boutique de vêtements avec système de commande intégré',
    ...
    },
    {
      ...
      description:
        'Plateforme de vente en ligne avec paiement Mobile Money et livraison géolocalisée',
    ...
    },
    {
      ...
      description:
        "Solution de télémédecine avec analyse d'image IA pour diagnostic préventif",
    ...
    },
    {
      ...
      description:
        'Site artistique immersif avec player audio intégré et galerie interactive',
    ...
    },
    {
      ...
      description:
        'Espace communautaire avec gestion des membres et système de dons sécurisé',
    ...
    },
    {
      ...
      description:
        'Modernisation complète avec optimisation SEO et performance ultra-rapide',
                  ...
                  >
                    ...
                    <div className="p-6 lg:p-8 space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div
                          className={`inline-flex items-center gap-2 text-sm font-medium bg-gradient-to-r ${project.bgGradient} px-3 py-1 rounded-full border border-green-200/50 dark:border-green-700/50`}
                        >
