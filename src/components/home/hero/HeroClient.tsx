...
function HeroSectionClient() {
  ...
  return (
    <section id="acceuil" className="relative overflow-hidden">
      ...
      <div className="container relative z-10 pt-12 pb-16 lg:pt-20 lg:pb-24 mt-10">
          ...
          <div className={`flex-1 text-center lg:text-left transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h1 className="text-4xl lg:text-6xl xl:text-7xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
              ...
              <span className="relative inline-block min-h-[1.2em]">
                ...
                <span 
                  ...
                  style={{ width: `${(displayText.length / Math.max(...rotatingWords.map(w => w.length))) * 100}%` }}
                ></span>
              </span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-6">
              <div className="flex items-center gap-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-md">
                ...
                <span className="font-medium text-gray-800 dark:text-gray-200">Mobile-first</span>
              </div>
              ...
              <div className="flex items-center gap-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-md">
                ...
                <span className="font-medium text-gray-800 dark:text-gray-200">Mobile Money</span>
              </div>
              ...
              <div className="flex items-center gap-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-md">
                ...
                <span className="font-medium text-gray-800 dark:text-gray-200">Ultra-rapide</span>
              </div>
            </div>
          </div>

          {/* Partie visuelle */}
          <div className={`flex-1 relative transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            
            {/* Mockup de téléphone */}
            <div className="relative mx-auto w-full max-w-lg lg:max-w-2xl xl:max-w-3xl">
              {/* Image de mockup */}
              <div className="relative bg-gray-900 rounded-3xl p-3 lg:p-4 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="absolute -top-6 -right-6 w-24 h-24 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold shadow-lg animate-bounce">
                <FiZap size={28} />
              </div>

              <div className="absolute -bottom-6 -left-6 w-20 h-20 bg-purple-500 rounded-full flex items-center justify-center text-white shadow-lg animate-pulse">
                <FiStar size={24} />
              </div>
