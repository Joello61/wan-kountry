...
function ServicesSection() {
  ...
  const servicesData = [
    {
      ...
      description: "Un site qui raconte votre histoire et convainc vos visiteurs en moins de 10 secondes",
      icon: FiGlobe,
    ...
    },
    {
      ...
      description: "Une boutique optimisée pour le mobile avec Mobile Money intégré",
      icon: FiShoppingCart,
    ...
    },
    {
      ...
      description: "Application web personnalisée pour automatiser votre business",
      icon: FiSettings,
    ...
    },
    {
      ...
      bgGradient: "from-teal-50 to-blue-50 dark:from-teal-900/30 dark:to-blue-900/30",
  ...
  const processSteps = [
    { icon: FiUsers, title: "Discussion", desc: "On se parle pour comprendre vos besoins" },
    { icon: FiSettings, title: "Design", desc: "Je créé les maquettes et on ajuste ensemble" },
    { icon: FiZap, title: "Développement", desc: "Je code pendant que vous vous occupez de votre business" },
    { icon: FiTrendingUp, title: "Lancement", desc: "Mise en ligne + formation + suivi" }
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/10 to-pink-500/10 px-4 py-2 rounded-full border border-purple-200/50 dark:border-purple-500/30 mb-6">
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Ce que je fais de mieux</span>
            </div>
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              <span className="text-gray-800 dark:text-white">Services qui </span>
              <span className="bg-gradient-to-r from-purple-600 via-blue-600 to-teal-600 bg-clip-text text-transparent">
                font la différence
              </span>
            </h2>
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Pas de blabla technique. Des <strong>solutions concrètes</strong> qui font grandir votre business.
              <br />
              Avec des <strong>résultats mesurables</strong> dès le premier mois.
            </p>
          </motion.div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className={`p-3 rounded-xl bg-gradient-to-r ${service.gradient} shadow-lg ${activeService === index ? 'scale-110' : ''} transition-transform duration-300`}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 text-sm mb-3">{service.subtitle}</p>
                      ...
                      <div className={`w-3 h-3 rounded-full bg-gradient-to-r ${service.gradient} ${activeService === index ? 'opacity-100' : 'opacity-30'} transition-opacity duration-300`} />
                    </div>
                  </motion.div>
                );
              })}
                  ...
                  <div className="space-y-6">
                          ...
                          <div className="flex items-center gap-2">
                            <div className="flex">
                              {[...Array(servicesData[activeService].testimonial.rating)].map((_, i) => (
                                <FiStar key={`star-${i}`} className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                              ))}
                            </div>
                    ...
                    <div className="flex flex-wrap gap-4">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className={`bg-gradient-to-r ${servicesData[activeService].gradient} text-white px-8 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2`}
                      >
                        Démarrer ce projet
                        <FiArrowRight />
                      </motion.button>
              ...
              {processSteps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h4 className="font-bold text-gray-800 dark:text-white mb-2">{step.title}</h4>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                Parlons de votre projet ! Consultation gratuite de 30 min pour définir la stratégie parfaite.
              </p>
