      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <h2 className="heading-1 mb-6">
            Ils nous ont fait <span className="text-gradient-warm">confiance</span>
            <br />
            et ne le regrettent pas
          </h2>
          
          <p className="body-large max-w-3xl mx-auto">
            Découvrez les retours authentiques de nos clients camerounais et africains. 
            Leurs <strong>succès concrets</strong> témoignent de notre expertise et de notre engagement.
          </p>
        </motion.div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="relative min-h-[400px]">
              <AnimatePresence mode="wait">
                ...
                >
                  <div className={`card-warm p-12 relative overflow-hidden`}>
                    
                    {/* Icône citation */}
                    <div className="absolute top-8 right-8 opacity-20">
                      <FaQuoteLeft size={64} className={`text-${testimonials[activeTestimonial]!.color}`} />
                    </div>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 items-center">
                      ...
                      <div className="lg:col-span-2 space-y-6">
                        ...
                        {/* Texte */}
                        <blockquote className="text-xl lg:text-2xl leading-relaxed italic font-medium">
                        ...
                        <div className="flex flex-wrap gap-6 pt-4 border-t border-border">
                          <div className="flex items-center gap-2 text-sm">
                            <FiTarget className={`text-${testimonials[activeTestimonial]!.color}`} />
                            <span className="font-semibold">Projet :</span>
                            <span>{testimonials[activeTestimonial]!.project}</span>
                          </div>
                          <div className="flex items-center gap-2 text-sm">
                            <FiClock className={`text-${testimonials[activeTestimonial]!.color}`} />
                            <span className="font-semibold">Durée :</span>
                            <span>{testimonials[activeTestimonial]!.duration}</span>
                          </div>
                          <div className="flex items-center gap-2 text-sm">
                            <FiTrendingUp className={`text-${testimonials[activeTestimonial]!.color}`} />
                            <span className="font-semibold">Résultat :</span>
                            <span className="text-accent font-bold">{testimonials[activeTestimonial]!.result}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        ...
                        {/* Avatar et identité */}
                        <div className="flex items-center gap-4">
                          <div className={`w-16 h-16 rounded-2xl bg-${testimonials[activeTestimonial]!.color}/10 flex items-center justify-center`}>
                            <span className={`text-2xl font-bold text-${testimonials[activeTestimonial]!.color}`}>
                              {testimonials[activeTestimonial]!.name.charAt(0)}
                            </span>
                          </div>
                          
                          <div>
                            <h4 className="font-bold text-text-strong text-lg">
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className="text-text-light">{testimonials[activeTestimonial]!.location}</span>
                        </div>

                        {/* Badge secteur */}
                        <div className={`chip bg-${testimonials[activeTestimonial]!.color}/10 text-${testimonials[activeTestimonial]!.color} inline-flex`}>
                          Client vérifié ✓
                        </div>
                      </div>
                    </div>
        ...
        >
          <div className="text-center mb-12">
            <h3 className="heading-3 mb-4">Découvrez d'autres retours clients</h3>
            <p className="body-text max-w-2xl mx-auto">
              Une sélection de témoignages qui illustrent notre approche et nos résultats.
            </p>
          </div>
              ...
              >
                ...
                <div className="flex items-center gap-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <FiStar key={i} className="text-accent fill-current" size={14} />
                  ))}
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-xl bg-${testimonial.color}/10 flex items-center justify-center`}>
        ...
        >
          <div className="card-glass p-12">
            <div className="text-center mb-12">
              <h3 className="heading-3 mb-4">Nos chiffres parlent d'eux-mêmes</h3>
              <p className="body-text max-w-2xl mx-auto">
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="body-text max-w-2xl mx-auto">
              Nous accompagnons des clients variés dans leur transformation digitale.
            </p>
          </div>

          <div className="flex flex-wrap justify-center gap-4">
  {sectors.map((sector, index) => {
    const Icon = sector.icon; // on récupère le composant
    return (
      <motion.div
        key={index}
        whileHover={{ scale: 1.05 }}
        className="card p-6 text-center min-w-[140px]"
      >
        <div className="text-2xl mb-2">
          <Icon className="mx-auto text-primary-600" /> {/* utilisation du composant */}
        </div>
          ...
          <div className="card-glass p-12 max-w-4xl mx-auto relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="heading-2 mb-6">
                Vous voulez être le prochain à <span className="text-gradient-warm">témoigner</span> ?
              </h3>
              
              <p className="body-large mb-8 max-w-2xl mx-auto">
                Rejoignez nos clients satisfaits et donnons vie ensemble à votre projet digital. 
                Consultation gratuite de 30 minutes pour commencer.
              </p>
